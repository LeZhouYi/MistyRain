...
import com.skily_leyu.misty_rain.block.BambooStalkBlock;
...
public class MistyRain {
    ...
    public static final DeferredHolder<Block, BambooStalkBlock> BAMBOO_STALK_BLOCK = BLOCKS.register("bamboo_stalk",
