...
public class MRConfig {
	...
	public static float[] peakMixRate = new float[] { 0.3F, 0.4F }; // 山峰图格混合比率
	public static float[] peakCellRate = new float[] { 0.25F, 0.35F, 0.75F, 0.85F, 1.0F };// 山峰图格比率
	public static float[] peakPointRadius = new float[]{0.3F,0.75F}; //山峰异形点计算范围
	public static float[] peakPointRate = new float[]{1.0F,1.5F}; //山峰异形点计算权重
