package skily_leyu.mistyrain.world.chunk;
...
public class MRChunkGenerator implements IChunkGenerator {
	...
	public MRChunkGenerator(World worldIn, long seed, String generatorOptions) {
		this.world = worldIn;
...
//							double d14 = 0.25D;
							...
							for (int l2 = 0; l2 < 4; ++l2) {
								if ((lvt_45_1_ += d16) > 0.0D) {
									...
									primer.setBlockState(i * 4 + k2, i2 * 8 + j2, l * 4 + l2, OCEAN);
								}
							}
